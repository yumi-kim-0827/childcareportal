const recipes = [
  ...
  },
  {
    ...
    name: "당근 미음",
    a1: "4~6개월",
    detail: "비타민A가 풍부한 이유식",
    a2: "당근: 20g, 쌀가루: 5g, 물: 100ml",
    a3: [
      "1. 당근은 껍질제거후 삶아서 부드럽게 찐다.",
      "2. 삶은 당근을 체에 걸러 즙을 냅니다.",
      "3. 쌀가루와 당근즙을 물에 섞어 약한 불에서 끓입니다.",
    ],
    a4: "좋음",
  },
  {
    ...
    name: "채소 퓌레",
    a1: "4~6개월",
    detail: "프랑스에서 자주 먹는 아기 이유식",
    a2: "당근, 호박, 고구마, 감자, 콜리플라워, 애호박 등, 물 또는 모유/분유",
    a3: [
      "1. 채소를 껍질을 벗기고 잘게 자릅니다.",
      "2. 물에 찌거나 삶아서 부드럽게 만듭니다.",
      "3. 부드럽게 으깨거나 블렌더로 갈아 퓌레로 만듭니다.",
      "4. 필요하면 모유나 분유를 섞어 묽게 조절합니다.",
    ],
    a4: "좋음",
  },
  {
  ...
  },
  {
    ...
    name: "닭가슴살 브로콜리 죽",
    a1: "6~8개월",
    detail: "지방이 적고 단백질이 풍부한 중기 이유식 레시피",
    a2: "닭가슴살: 20g, 브로콜리: 10g, 쌀: 10g, 물: 250ml",
    a3: [
      "1. 닭가슴살을 찜기에 찐 후 곱게 다진다.",
      "2. 브로콜리를 끓는 물에 살짝 데친 후 다진다.",
      "3. 불린 쌀과 물을 냄비에 넣고 죽을 끓이며, 닭가슴살과 브로콜리를 추가한다.",
      "4. 부드러운 농도로 갈아준다.",
    ],
    a4: "보통",
  },
  ...
  },
  {
    ...
    a1: "8~12개월",
    detail:
      "소화기와 씹는 능력이 점차 발달시키며, 자기주도 이유식으로도 활용하기 좋은 레시피",
    a2: "닭 가슴살: 30g, 감자: 30g, 당근: 20g, 양파: 10g, 물: 150ml",
    a3: [
      "1. 닭 가슴살과 야채를 깨끗이 씻어 작게 다집니다.",
      "2. 냄비에 물을 끓이고 닭고기와 야채를 넣어 부드러워질 때까지 끓입니다.",
      "3. 완성된 스튜를 아기에게 맞는 농도로 믹서기로 갈거나 잘게 다져 제공합니다.",
    ],
    a4: "아주 좋음",
  },
  {
    ...
    detail:
      "소화기와 씹는 능력이 점차 발달시키며, 자기주도 이유식으로도 활용하기 좋은 레시피",
    a2: "쇠고기 (안심): 30g, 브로콜리: 20g, 쌀가루: 2큰술, 물: 200ml",
    a3: [
      "1. 쇠고기를 끓는 물에 데친 후 다집니다.",
      "2. 브로콜리를 찐 후 잘게 다지거나 으깹니다.",
      "3. 냄비에 물과 쌀가루를 넣고 끓이며 걸쭉하게 만듭니다.",
      "4. 준비된 쇠고기와 브로콜리를 넣어 잘 섞어 완성합니다.",
    ],
    a4: "좋음",
  },
];
